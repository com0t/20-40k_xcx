...
jQuery(document).ready(function ($) {
                ...
                $('#jutranslations-languages tbody tr[data-slug="' + julanguage.extension + '"]').each(function () {
                    ...
                    $.each(data.data, function () {
                        if (this.language === lang && this.extension === slug) {
                            ...
                            $('.jutranslation-install').off().on('click', function (e) {
                                e.preventDefault();
    ...
    $('.jutranslation-edition').on('click', function (e) {
        e.preventDefault();
    ...
    $('.jutranslation-override').on('click', function (e) {
        e.preventDefault();
    ...
    $('.jutranslation-share').on('click', function (e) {
        e.preventDefault();
    ...
    function doTable(datas, options) {
        ...
        $_content.find('[class^="do_table_copy_"]').on('click', function (e) {
            e.preventDefault();
        ...
        //Save and close
        $_content.find('.do_table_confirm').on('click', function (e) {
            options.confirm_button_action(e, $_content, true);
        });

        //Confirm the current action
        $_content.find('.do_table_save').on('click', function (e) {
            options.confirm_button_action(e, $_content, false);
        });

        //Cancel the current action
        $_content.find('.do_table_cancel').on('click', function (e, $_content) {
            options.cancel_button_action(e);
        });
